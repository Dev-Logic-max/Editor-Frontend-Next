...
import { Check, Eye, Trash2, ExternalLink, X, Edit2, Save, FileText, Upload } from 'lucide-react';
...
interface MediaProGridViewProps {
    media: MediaItem[];
    ...
    showDocumentInfo?: boolean; // ✅ NEW: Show document info in all mode
}
export function MediaProGridView({
    media,
    selectedItems,
    onToggleSelection,
    onInsert,
        ...
        `}
          ...
          `}>
                        ...
                        <div className="p-3 bg-white border-t space-y-2">
                            ...
                            {/* ✅ Document Info (Pro Mode) */}
                            {showDocumentInfo && (
                                <div className="flex items-center gap-1 text-xs text-gray-500 bg-blue-50 rounded px-2 py-1">
                            ...
                            <div className="flex items-center justify-between text-xs text-gray-500">
                                <div className="flex items-center gap-1">
                                    <Avatar className="h-4 w-4">
                                        <AvatarImage
                                            src={item.uploadedBy?.profilePhoto ? `${process.env.NEXT_PUBLIC_API_URL}/uploads/profile/${item.uploadedBy.profilePhoto}` : undefined}
                                        />
